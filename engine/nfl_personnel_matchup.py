...
def build_personnel_matchup_context(
    *,
    ...
    return {
        ...
        "overall_style_advantage": style_context.get("overall_advantage"),
        "overall_style_strength": style_context.get("overall_strength"),
        "overall_style_edge": style_context.get("overall_edge"),
        "overall_style_why": style_context.get("overall_why"),
        "overall_style_weighted_drivers": list(style_context.get("overall_weighted_drivers", []) or []),
        "leader": leader,
