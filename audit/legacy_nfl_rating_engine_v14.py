"""FROZEN COPY of the v1.4 rating engine, kept only so audit/nfl_rating_backtest.py
can compare the old weighting against the current engine. Do not import from
production code.
